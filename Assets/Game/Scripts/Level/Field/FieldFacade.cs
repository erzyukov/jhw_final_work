namespace Game.Field
{
	...
	public interface IFieldFacade
	{
		...
		IFieldCell GetCell( Vector2Int position );
		IFieldCell GetCell( Vector2 worldPosition );
	...
	public class FieldFacade : MonoBehaviour, IFieldFacade
	{
		...
		public IFieldCell GetCell( Vector2Int position ) => Field.GetCell( position );
		public IFieldCell GetCell( Vector2 worldPosition ) => Field.GetCell( worldPosition );
